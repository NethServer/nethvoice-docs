...
- **Parcheggiare la chiamata**: Parcheggia la chiamata per un successivo ritiro (soggetto a specifici permessi)
- **Aggiungi partecipanti alla chiamata**: Puoi aggiungere più partecipanti alla conferenza (soggetto a specifici permessi)

![Phone_Island_features](/img/nethcti/Phone_Island_espansione_totale.png)

In altre azioni puoi:
